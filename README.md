...
Utilizes a MongoDB Time-To-Live (TTL) index to maintain a rolling 24-hour cache of analyzed URLs. This prevents database race conditions, protects external API rate limits, and ensures report generation in 5-7 seconds.

Tech Stack
Frontend: Angular, HTML5, native CSS
Backend: Python, Flask
Databases: Azure Cosmos DB (Production), MongoDB (Testing)
